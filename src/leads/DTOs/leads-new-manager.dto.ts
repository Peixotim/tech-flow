...
export class LeadsNewManagerDTO {
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    example: LeadOrigin.INSTAGRAM,
    enum: LeadOrigin,
  })
  @IsNotEmpty({ message: 'Origin is required.' })
  @IsEnum(LeadOrigin, {
    message:
      'Origin must be one of: linkedin, instagram, youtube, google_organic, google_ads, facebook, indication, website, api,other.',
  })
  origin: LeadOrigin;
